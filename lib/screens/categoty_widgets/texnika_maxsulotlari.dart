...
class TechnicalProducts extends StatefulWidget {
  const TechnicalProducts({super.key});

  @override
  State<TechnicalProducts> createState() => _TechnicalProductsState();
}

class _TechnicalProductsState extends State<TechnicalProducts> {
  @override
